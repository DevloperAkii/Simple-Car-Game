import { Application, Assets, Sprite , Graphics ,Container , Color, Texture, Ticker  } from "pixi.js";
...
function Game(){
  ...
  //Create Road Rect
  const roadRect = new Graphics().rect(app.screen.width / 2, 0,500,app.screen.height).fill('black')
